...
import ('./__button/_register/sign-up__button_register.css');
import ('./__footer/sign-up__footer.css');
import ('./__text/sign-up__text.css');
import ('./__link/sign-up__link.css');

export default function SignForm ({ title, children, button, text, link, linkText }) {
  return (
    <section className="sign-up">
       ...
       <form className="sign-up__form">
         { children }
        <button className="sign-up__button">{ button }</button>
       </form>
